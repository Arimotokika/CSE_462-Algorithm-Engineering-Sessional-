...
runtime remains central in operational settings.
...
\begin{itemize}
  ...
  \item We propose \textbf{Hybrid GA}, which addresses three identified
      ...
      with stagnation detection, and a threat-proportional mutation
        operator.
...
\subsubsection{Fix 3: Threat-Proportional Mutation (Domain-Aware WTA-Specific Operator)}
...
well-covered targets.  This is a domain-aware, WTA-specific contribution: it
...
modifications that empirically improve performance on our benchmark.
